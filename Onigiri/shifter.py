...
def snap(sarm=None, tarms=[], type="rig", source=[]):
    ...
    for tarm in tarms:
        if tarm not in obj:
            print(
                "shifter::snap: an armature sent to this function does not exist:", tarm
            )
    ...
    if shaper == True:
        ...
        for bone in bone_map:
            ...
            glueObj.pose.bones[bone].constraints[lname].keyframe_insert(
                data_path="influence"
            )
            glueObj.pose.bones[bone].constraints[rname].keyframe_insert(
                data_path="influence"
            )
        for boneObj in glueObj.pose.bones:
            bone = boneObj.name
            ...
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="location", frame=st_start
            )
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="rotation_quaternion", frame=st_start
            )
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="rotation_euler", frame=st_start
            )
        ...
        for boneObj in glueObj.pose.bones:
            ...
            glueObj.data.bones[bone].select = True
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="location", frame=st_start + 1
            )
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="rotation_quaternion", frame=st_start + 1
            )
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="rotation_euler", frame=st_start + 1
            )
        ...
        for boneObj in glueObj.pose.bones:
            ...
            glueObj.data.bones[bone].select = True
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="location", frame=st_start + 2
            )
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="rotation_quaternion", frame=st_start + 2
            )
            glueObj.pose.bones[bone].keyframe_insert(
                data_path="rotation_euler", frame=st_start + 2
            )
...
def morph(
    ...
    if frame_range < 3:
        reverse = False
        print(
            "reverse requires at least 3 frames,",
            frame_range,
            "was given so reverse is disabled",
        )
    else:
    ...
    if reverse == True:
        ...
        for gbone in bone_map:
            ...
            glueObj.pose.bones[gbone].constraints[lname].keyframe_insert(
                data_path="influence"
            )
            glueObj.pose.bones[gbone].constraints[rname].influence = 1
            glueObj.pose.bones[gbone].constraints[rname].keyframe_insert(
                data_path="influence"
            )
            glueObj.pose.bones[gbone].constraints[sname].influence = 1
            glueObj.pose.bones[gbone].constraints[sname].keyframe_insert(
                data_path="influence"
            )
...
def pose_to(
    ...
    for boneObj in glueObj.pose.bones:
        ...
        glueObj.pose.bones[bone].keyframe_insert(
            data_path="rotation_quaternion", frame=frame_start
        )
        glueObj.pose.bones[bone].keyframe_insert(
    ...
    for boneObj in glueObj.pose.bones:
        bone = boneObj.name
        glueObj.pose.bones[bone].keyframe_insert(
            data_path="location", frame=frame_start + frame_range - 1
        )
        glueObj.pose.bones[bone].keyframe_insert(
            data_path="rotation_quaternion", frame=frame_start + frame_range - 1
        )
        glueObj.pose.bones[bone].keyframe_insert(
            data_path="rotation_euler", frame=frame_start + frame_range - 1
        )
        glueObj.pose.bones[bone].keyframe_insert(
            data_path="scale", frame=frame_start + frame_range - 1
        )
