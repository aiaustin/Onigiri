...
def get_director(object, report=False):
    ...
    if report == True:
        ...
        if aObj == None:
            ...
            print(
                "motion::get_director : Found actor, this must be the director:",
                aObj.name,
            )
        ...
        if dObj == None:
            ...
            print(
                "motion::get_director : Found director",
                dObj.name,
...
def retarget_hard(inRig):
    ...
    if 1 == 0:
        if len(good_bones_out) == 0:
            print(
                "motion::retarget_hard = None of the bones in the available map matched your target."
            )
    ...
    if 1 == 1:
        ...
        if utils.is_valid(proxyRig):
            ...
            for boneObj in proxyRig.pose.bones:
                ...
                proxyRig.pose.bones[boneObj.name].matrix = mathutils.Matrix(
                    dBone["matrix_local"]
                )
                ...
                if bone in proxyRig.pose.bones:
                    ...
                    for cname in boneObj["oni_motion_constraints"]:
                        ...
                        if tbone in outRig.pose.bones:
                            for cname in outRig.pose.bones[tbone][
                                "oni_motion_constraints"
                            ]:
